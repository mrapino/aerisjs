define([
  ...
  */
  ...
  PointDataMarker.prototype.lookupUrl_ = function() {
    ...
    iconName = _.isString(iconName) ? iconName : iconName.name;
  ...
  /**
   * Find the appropriate x offset for this icon.
   *
   * @protected
   */
  PointDataMarker.prototype.lookupOffsetX_ = function() {
    var type = this.getType() || this.lookupType_();
    return this.lookupTypeIcon_(type).offsetX;
  };

  /**
   * Find the appropriate y offset for this icon.
   *
   * @protected
   */
  PointDataMarker.prototype.lookupOffsetY_ = function() {
    var type = this.getType() || this.lookupType_();
    return this.lookupTypeIcon_(type).offsetY;
  };
