define(function() {
  ...
  return {
    ...
    routeDetailsModule: {
      create: {
        ...
        args: [{
          ...
          trailWaypointsController: { $ref: 'trailWaypointsController' }
        }]
      }
    },
    ...
    // Controls trail waypoint markers
    trailWaypointsController: {
      create: {
        module: 'polaris/routeplanner/routedetails/controller/publicwaypointcontroller',
        args: [{
          model: { $ref: 'trailWaypointToggle' },
          data: { $ref: 'trailWaypointCollection' },
