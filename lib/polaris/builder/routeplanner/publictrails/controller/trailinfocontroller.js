define([
  ...
  */
  var TrailInfoController = function(opt_options) {
    ...
    options.templateHelpers = function() {
      return {
        ...
        openClosed: this.lookupOpenClosed_()
      }
    };
  ...
  TrailInfoController.prototype.lookupOpenClosed_ = function() {
    var isOpen = !this.model.getAtPath('open');
    if (_.isUndefined(isOpen)) { return 'Unknown'; }
